            ...
            <div>
                @if ($filters)
                    <x-filament::input.wrapper>
                        <x-filament::input.select wire:model.live="filter" wire:loading.class="animate-pulse" @class([
                        'apex-charts-single-filter w-full', // px-2 py-1 text-gray-900 border border-gray-300 block h-10 transition transition-duration-75 rounded-lg shadow-sm focus:border-primary-500 focus:ring-1 focus:ring-inset focus:ring-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:focus:border-primary-500
                    ])>
